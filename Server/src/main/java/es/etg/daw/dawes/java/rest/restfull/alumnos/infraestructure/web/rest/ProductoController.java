...
public class ProductoController {
    ...
    public ResponseEntity<ProductoResponse> createProducto(
        ...
        Alumno producto = createProductoService.createProducto(comando);
    ...
    public ResponseEntity<?> deleteProducto(@PathVariable int id) {
        deleteProductoService.delete(new AlumnoId(id)); // convertimos id en ProductoId
    ...
    public ProductoResponse editProducto(@PathVariable int id, @RequestBody ProductoRequest productoRequest) {
        ...
        Alumno producto = editProductoService.update(comando);
